...
function CleanUpStartMenuItems {
	...
	@(
		...
		[StartMenuCleanupItem]::FromCommonPrograms('Microsoft Mouse and Keyboard Center.lnk', 'Maintenance')
		...
		[StartMenuCleanupItem]::FromCommonPrograms('PerfectDisk.lnk', 'Maintenance')
		...
		[StartMenuCleanupItem]::FromCommonPrograms('Waves MaxxAudioPro.lnk', 'Maintenance')	# shows up as 'System'
		...
		[StartMenuCleanupItem]::FromCommonPrograms('Dell\Dell Display Manager\Dell Display Manager*.lnk', 'Maintenance', $true)
		[StartMenuCleanupItem]::FromCommonPrograms('Dell\*.lnk', 'Maintenance', $true)
		...
		[StartMenuCleanupItem]::FromCommonPrograms('Logi Firmware Update Tool\BRIO.lnk', 'Maintenance', 'Logitech BRIO Firmware Update.lnk', $true)
		[StartMenuCleanupItem]::FromCommonPrograms('Logitech Camera Settings\Logitech Camera Settings.lnk', 'Maintenance', $true)
		...
		[StartMenuCleanupItem]::FromCommonPrograms('Microsoft Mouse and Keyboard Center\Microsoft Mouse and Keyboard Center.lnk', 'Maintenance', $true)
		...
		[StartMenuCleanupItem]::FromUserPrograms('MaxxAudio Pro by Waves*.lnk', 'Maintenance')
		...
		[StartMenuCleanupItem]::FromUserPrograms('C989M Application Software\C989M Application Software.lnk', 'Maintenance', $true)
