...
function CleanUpStartMenuItems {
	...
	@(
		...
		[StartMenuCleanupItem]::FromCommonPrograms('Clink\Clink.lnk', $applications, $true)
		...
		[StartMenuCleanupItem]::FromCommonPrograms('JetBrains\JetBrains PyCharm*.lnk', $development, 'PyCharm.lnk')
		[StartMenuCleanupItem]::FromCommonPrograms('JetBrains\JetBrains Rider*.lnk', $development, 'Rider.lnk')
		[StartMenuCleanupItem]::FromCommonPrograms('JetBrains\JetBrains RustRover*.lnk', $development, 'RustRover.lnk')
		[StartMenuCleanupItem]::FromCommonPrograms('JetBrains\JetBrains WebStorm*.lnk', $development, 'WebStorm.lnk', $true)
		...
		[StartMenuCleanupItem]::FromUserPrograms('JetBrains\JetBrains DataGrip*.lnk', $development, 'DataGrip.lnk')
		...
		[StartMenuCleanupItem]::FromUserPrograms('JetBrains\JetBrains PyCharm*.lnk', $development, 'PyCharm.lnk')
		[StartMenuCleanupItem]::FromUserPrograms('JetBrains\JetBrains Rider*.lnk', $development, 'Rider.lnk')
		[StartMenuCleanupItem]::FromUserPrograms('JetBrains\JetBrains RustRover*.lnk', $development, 'RustRover.lnk')
		[StartMenuCleanupItem]::FromUserPrograms('JetBrains\JetBrains WebStorm*.lnk', $development, 'WebStorm.lnk', $true)
