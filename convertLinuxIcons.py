	...
	def __init__(self, inputPath : pathlib.Path, pngsBasePath : pathlib.Path, iconsBasePath : pathlib.Path, tempPath : pathlib.Path):
		...
		self._iconTypeLists : List[IconTypeList] = [
			IconTypeList("mimetypes", { "Humanity": "mimes" }, [
				...
				Icon("application-vnd.debian.binary-package", ["application-x-deb"], ["deb"]),
				...
				Icon("application-x-java-archive", ["application-java-archive", "application-x-jar", "gnome-mime-application-x-java-archive", "gnome-mime-application-x-jar"], extensions=["jar"]),
				Icon("application-vnd.android.package-archive", ["android-package-archive", "application-apk", "application-x-apk"], extensions=["apk"]),
				...
				Icon("application-x-xz", ["xz"]),
				Icon("application-x-xz-compressed-tar", ["txz", "tar.xz"]),
				Icon("application-x-yaml", ["text-x-yaml"], ["yaml", "yml"]),
				Icon("application-x-zstd-compressed-tar", ["tzst", "tar.zst"]),
				...
				Icon("application-zstd", ["zst"]),	# aren't any of these yet, but in case they show up...
				...
				Icon("audio-ogg", ["audio-x-vorbis+ogg", "audio-x-ogg", "audio-x-flac+ogg", "audio-x-speex+ogg"], ["oga", "ogg", "opus"]),
				Icon("audio-webm"),
				Icon("audio-x-aiff", ["media-audio"]),
				Icon("audio-x-generic", ["media-audio"]),
				Icon("audio-x-matroska", extensions=["mka"]),
				Icon("audio-x-mod", extensions=["mod", "669"]),
				Icon("audio-x-monkey", extensions=["ape"]),
				...
				Icon("audio-x-wav", ["audio-wav", "audio-vnd.wave"], ["wav"]),
				Icon("application-x-cue", ["application-x-cd-image", "application-x-iso"], ["cue"]),
